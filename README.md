# 🏠 Real_Estate_Market_Analysis - Metro_Manila (Excel)
### 📊 Project Overview
The goal of this analysis is to identify which areas and property types are performing best to help the company decide where to focus marketing and development investments next quarter.
...
- Analyze property type performance (e.g., House, Condo, Apartment)
- Identify top-performing cities in Metro Manila
- Compare For Sale vs Sold ratios
- Discover which property type performs best per area
- Observe monthly sales trends

## 1. Which property types sell the most?
**Houses** are the top-performing property type, with the highest number of sold units — showing the strongest buyer demand compared to condos, apartments, and townhouses.

<img width="1033" height="387" alt="image" src="https://github.com/user-attachments/assets/5e8e7438-4141-4fd7-93fc-402c3c9e0ece" />

## 2. Which cities have the highest sales?
**Pasig** and **Parañaque** show the highest sales activity, making them the strongest-performing cities and likely the most profitable areas for real estate focus.
